...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <script>
            ...
            Livewire.on('email_noexiste', function(message){
                Swal.fire(
                    'The email I entered does not exist as a user in our system. Check',
                    '',
                    'error'
                )
            })
            ...
            Livewire.on('exito', function(message){
                Swal.fire(
                    'Machine successfully registered, please log in to track it',
                    '',
                    'success'
                )
            })

<header>
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="{{ route('dashboard-franchisee') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <li>
                        <a href="{{ route('dispositivos') }}" class="block py-2 px-3 text-gray-400 hover:text-blue-300 md:p-0">{{ __('Devices') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('alertas') }}" class="block py-2 px-3 text-gray-400 hover:text-blue-300 md:p-0">{{ __('Alerts') }}</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('perfil-franchisee') }}" class="block py-2 px-3 text-gray-400 hover:text-blue-300 md:p-0">{{ __('Profile') }}</a>
                    </li>
                    <li>
